package com.ruifucredit.springboot.test;

import com.ruifucredit.springboot.SpringbootApplication;
...
public class UserRepositoryTests {
    ...
    public void test() throws Exception {
        ...
        Assert.assertEquals(6, userRepository.findAll() == null ? 0 : userRepository.findAll().size());
